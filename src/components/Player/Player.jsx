...
const Player = () => {
    const {seekBg,track,seekBar,playStatus,time,play,pause} = useContext(PlayerContext);
        ...
        <div className='h-[10%] bg-black flex justify-between items-center  text-white px-4'>
            ...
            <div className='flex flex-col items-center gap-1 m-auto  '>
                ...
                <div className='flex items-center gap-5'>
                    ...
                    <div ref={seekBg} className='w-[60vw] max-w-[400px] bg-gray-300 rounded-full cursor-pointer'>
